    ...
    <section class="content">
      <div class="row">
                                  ...
                                  <div class="modal-dialog">
                                    <div class="modal-content">
                                      ...
                                      <div class="modal-footer">
                                        ...
                                        <button type="button" class="btn btn-primary">Save Supplies</button>
                                      </div>
                                    </div>
                                    <!-- /.modal-content -->
                                  </div>
        ...
        <table id="example1" class="table table-bordered table-striped">
          <?php
            require_once("../../../db.php");
            $sql = "SELECT purchase_order_supplies.order_date, purchase_order_supplies.order_time, 
		description, purchase_order_supplies.quantity, unit, deliveries.delivery_date, deliveries.delivery_time,
		purchase_order_supplies.unit_price, total_amount from purchase_orders INNER JOIN deliveries ON purchase_orders.po_id = deliveries.po_id
		INNER JOIN purchase_order_supplies ON deliveries.supply_id = purchase_order_supplies.supply_id ";
        ...
        <?php if ($result->num_rows > 0) {
          while($row = $result->fetch_assoc()) { ?>
            ...
            <td><form action="php/purchasesDelete.php">
                  <input type="text" name="purDelete" hidden value="<?php echo $row["description"]; ?>">
      ...
      <div class="row no-print">
        <div class="col-xs-12">
          <a href="../examples/invoice-print5.php" target="_blank" class="btn btn-default"><i class="fa fa-print"></i> Print</a>
