  ...
  <aside class="main-sidebar">
	...
	<!---------------------------------------------------- DASHBOARD MENU -------------------------------------------------------------->
        ...
        <li class= "treeview">
          ...
          <ul class="treeview-menu">
			<li><a href="../tables/data.php"><i class= "fa fa-medkit"></i> Medical Supplies</a></li>
			<li><a href="../tables/data2.php"><i class="fa fa-pencil-square-o"></i> Office Supplies</a></li>
          </ul>
        </li>
        <!--------------------------------------------------- PURCHASES -------------------------------------------------->
          <li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <!-- /.row -->
        ...
        <div class="col-xs-12">
          <a href="/examples/invoice-print.html" target="_blank" class="btn btn-default"><i class="fa fa-print"></i> Print</a>
